...
/** 此处后端没有提供注释 POST /user/apps */
export async function getUserApps(
  body: API.UserAppsQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVO>('/user/apps', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/email/send */
export async function sendEmailCode(
  body: API.SendEmailCodeRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean>('/user/email/send', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/profile/update */
